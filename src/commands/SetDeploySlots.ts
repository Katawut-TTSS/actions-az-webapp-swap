...
export class SetDeploySlots {
  ...
  public async execute() {
    ...
    await this.setAppSettings(AppSettingsType.AppSettings);
    await this.setAppSettings(AppSettingsType.ConnectionStrings);
  }
  ...
  private async setAppSettings(type: AppSettingsType) {
    ...
    await appSetting.setWebAppSourceSlot();
    await appSetting.setWebAppTargetSlot();
  }
}
